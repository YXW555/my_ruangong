            ...
            <div class="order-page-container">
                ...
                <el-card class="order-action-card" shadow="hover">
                    ...
                    <div class="order-actions">
                        ...
                        <div v-if="orderInfo.orderStatus===3" class="order-completed">
                            ...
                            <el-button 
                                v-if="userId==orderInfo.userId && !hasRating" 
                                type="primary" 
                                round 
                ...
                <el-dialog
                    ...
                    <div slot="footer" class="dialog-footer">
                        ...
                        <el-button type="primary" @click="submitRating" :disabled="ratingForm.rating === 0">提交评价</el-button>
                    </div>
                </el-dialog>
            </div>
            <app-foot></app-foot>
            ...
            this.$nextTick(()=>{
                ...
                this.$api.getOrder({
                    ...
                    if (res.status_code === 1) {
                        ...
                        // 检查是否已评价
                        if (this.orderInfo.orderStatus === 3 && this.orderInfo.userId == this.userId) {
                            this.checkRating();
                        }
                    }
                })
            ...
            submitRating() {
                ...
                this.$api.addRating({
                    ...
                    if (res.status_code === 1) {
                        ...
                        this.$message.error('评价失败：' + (res.msg || '未知错误'));
                    }
                }).catch(e => {
